...
Bitte haben Sie Verständnis dafür, dass ich öffentlich keine Endkunden nenne.
...
- **Technologien:** Linux (RHEL), Spring Boot, Bash, Maven, AdoptOpenJDK 11, Docker, Docker Compose, Hashicorp Vault, ELK, Jenkins, OpenVPN, TestRail, Jira, Confluence
...
### Software-Entwickler, Administrator, Trainer
